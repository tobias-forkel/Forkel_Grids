...
class Forkel_Grids_Block_Adminhtml_Renderer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setId('forkel_grids_renderer_grid');
     ...
     *
     * @return Forkel_Grids_Block_Adminhtml_Renderer_Grid
     */
