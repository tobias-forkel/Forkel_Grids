...
class Forkel_Grids_Block_Adminhtml_Renderer_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        ...
        {
            return $this->__('Forkel Grids > Renderer > Edit');
        }

        return $this->__('Forkel Grids > Renderer > New');
    }
}