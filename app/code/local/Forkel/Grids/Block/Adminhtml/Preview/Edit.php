...
class Forkel_Grids_Block_Adminhtml_Preview_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        ...
        {
            return $this->__('Forkel Grids > Preview > Edit');
        }

        return $this->__('Forkel Grids > Preview > New');
    }
    ...
    protected function _prepareLayout()
    {
        $this->addButton('preview', array(
            'label'     => $this->__('Preview & Save Data'),
            'onclick'   => 'setLocation(\'' . $this->getUrl('*/*/preview') . '\')',
            'class'     => 'save',
        ));
