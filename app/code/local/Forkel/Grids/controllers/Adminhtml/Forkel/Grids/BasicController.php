...
class Forkel_Grids_Adminhtml_Forkel_Grids_BasicController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Initialize action
     *
    ...
    {
        $this->_title($this->__('Forkel Grids'))->_title($this->__('Basic'));
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('forkel_grids/adminhtml_basic_edit')->setData('action', $this->getUrl('*/*/save')))
            ->renderLayout();
    }
